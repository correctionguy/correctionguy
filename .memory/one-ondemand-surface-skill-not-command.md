...
**How to apply:** When changing agent-facing discipline, sync `scripts/prompts.ts` (SESSION_START) with `skills/correctionguy/SKILL.md` only. Setup remains `skills/setup/SKILL.md` (`correctionguy:setup`). See [[release-process]].
