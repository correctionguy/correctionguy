...
**How to apply:** Baked into every guidance surface on 2026-07-08: `scripts/prompts.ts` (SESSION_START preamble, STOP_PROMPT block list, LIVE_MONITOR_PROMPT flag #10), `skills/correctionguy/SKILL.md` ("Never wipe user's work"), and AGENTS.md User's Claim. Keep these in lockstep when editing, per [[release-process]]. Recorded as a User's Claim per [[memories-default-to-dot-memory]].
