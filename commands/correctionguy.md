...
2. **Track.** Multi-step work -> keep todo list, update as you go: mark steps start + done, keep in sync, use whatever tracker is set up. Many or repeated asks -> log each as its own todo at once, do not just hold them in your head.
